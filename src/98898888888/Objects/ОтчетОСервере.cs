...
namespace IIS.98898888888
{
    ...
    public class ОтчетОСервере : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.98898888888.РежимСервера fРежим;
        
        private IIS.98898888888.Расположение fРасположение;
        ...
        public virtual IIS.98898888888.РежимСервера Режим
        {
            get
            {
                ...
                IIS.98898888888.РежимСервера result = this.fРежим;
        ...
        [PropertyStorage(new string[] {
                "Расположение"})]
        [NotNull()]
        public virtual IIS.98898888888.Расположение Расположение
        {
            get
            {
                ...
                IIS.98898888888.Расположение result = this.fРасположение;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтчетОСервереE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОСервереE", typeof(IIS.98898888888.ОтчетОСервере));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтчетОСервереL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОСервереL", typeof(IIS.98898888888.ОтчетОСервере));
                }
            }
        }
    }
